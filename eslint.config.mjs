...
export default [
	...
	// shadcn-generated primitives: many are unused scaffolding importing optional
	// Radix packages that aren't installed. Their runtime is fine; silence only the
	// module-resolution rule here so real linting still applies to the used ones.
	{ files: ['src/components/ui/**'], rules: { 'import/no-unresolved': 'off' } },
];
